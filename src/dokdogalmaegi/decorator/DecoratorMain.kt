...
fun main() {
    val espresso = BasicCoffee()
    println("${espresso.description()} costs ${espresso.cost()}")

    val espressoWithMilk = MilkDecorator(espresso)
    println("${espressoWithMilk.description()} costs ${espressoWithMilk.cost()}")

    val espressoWithMilkAndSugar = SugarDecorator(espressoWithMilk)
